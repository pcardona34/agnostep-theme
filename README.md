> [!CAUTION]
> Since the release 2.0.0 of [Agnostep Desktop](../agnostep-desktop) this repo is only relevant for ARTS backups. The **installation** scripts and resources, likemain theme bundle and wallpaers, were reverted to the main desktop project repository. 

# agnostep-theme

GNUstep theme for the [AGNoStep Desktop Project](../agnostep-desktop).
...
Use [main desktop project](../agnostep-desktop) repository...
